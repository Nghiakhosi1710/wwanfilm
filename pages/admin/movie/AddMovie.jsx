...
const AddMovie = () => {
    ...
    const handleDiscard = useCallback(() => {
        ...
        toast.info("Đã hủy bỏ thay đổi và xóa bản nháp.", { /* toast options */ });
    }, [resetForm]);

    const handleSaveDraft = useCallback(() => {
        if (!data.title.trim()) {
            toast.warn("Tên phim không được để trống để lưu nháp.", { /* toast options */ });
            return;
        }
    ...
    const handleSave = async (e) => {
        ...
        if (!picture.image) {
             toast.warn("Vui lòng thêm hình ảnh chính cho phim.", { /* toast options */ });
            return;
        }
         if (!picture.posterImage) {
             toast.warn("Vui lòng thêm ảnh poster cho phim.", { /* toast options */ });
            return;
        }
        ...
        try {
            ...
            toast.success("Đã thêm phim mới thành công!", { /* toast options */ });
